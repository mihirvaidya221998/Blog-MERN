...
import { HiOutlineUserGroup, HiAnnotation, HiOutlineDocumentText } from "react-icons/hi";
    ...
    useEffect(() => {
        ...
        const fetchPosts = async() => {
            try {
                ...
                if (res.ok){
                    setPosts(data.posts);
                    setTotalPosts(data.totalNumPosts);
        ...
        <div className="flex flex-wrap gap-4 py-3 mx-auto justify-center">
            ...
            <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
                <div className="flex justify-between p-3 text-sm font-semibold">
                    ...
                    <Button outline gradientDuoTone="tealToLime"><Link to='/dashboard?tab=users'>See All</Link></Button>
                </div>
                    ...
                    {users && users.map((user) => (
                        <Table.Body key={user._id} className='divide-y'>
                            <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                                <Table.Cell>
                                    <img src={user.profilePic} alt='user' className='w-10 h-10 rounded-full bg-gray-500'/>
                                </Table.Cell>
                                <Table.Cell>
                                    {user.username}
                                </Table.Cell>
            ...
            {/* Comments */}
             <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
                <div className="flex justify-between p-3 text-sm font-semibold">
                    ...
                    <Button outline gradientDuoTone="tealToLime"><Link to='/dashboard?tab=comments'>See All</Link></Button>
                </div>
                <Table hoverable className=''>
                    <Table.Head>
            ...
            {/* Posts */}
             <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
                <div className="flex justify-between p-3 text-sm font-semibold">
                    ...
                    <Button outline gradientDuoTone="tealToLime"><Link to='/dashboard?tab=posts'>See All</Link></Button>
                </div>
                <Table hoverable className=''>
                    <Table.Head>
